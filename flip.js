...
Module['FS_createPath']("/shaders", "desktop", true, true);
Module['FS_createPath']("/shaders", "web", true, true);
    ...
    loadPackage({"files": [{"filename": "/shaders/desktop/point.fs", "start": 0, "end": 418}, {"filename": "/shaders/desktop/point.vs", "start": 418, "end": 1152}, {"filename": "/shaders/web/point.fs", "start": 1152, "end": 1705}, {"filename": "/shaders/web/point.vs", "start": 1705, "end": 2431}], "remote_package_size": 2431});

  })();

// end include: /tmp/tmplvb7dg51.js
// include: /tmp/tmpxk3ri5f9.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpxk3ri5f9.js
// include: /tmp/tmppntixrmn.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmppntixrmn.js
...
var ASM_CONSTS = {
  94488: () => { if (document.fullscreenElement) return 1; },  
 94534: () => { return Module.canvas.width; },  
 94566: () => { return parseInt(Module.canvas.style.width); },  
 94614: () => { document.exitFullscreen(); },  
 94641: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 94714: () => { if (document.fullscreenElement) return 1; },  
 94760: () => { return Module.canvas.width; },  
 94792: () => { return screen.width; },  
 94817: () => { document.exitFullscreen(); },  
 94844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94977: () => { return window.innerWidth; },  
 95003: () => { return window.innerHeight; },  
 95030: () => { if (document.fullscreenElement) return 1; },  
 95076: () => { return Module.canvas.width; },  
 95108: () => { return parseInt(Module.canvas.style.width); },  
 95156: () => { if (document.fullscreenElement) return 1; },  
 95202: () => { return Module.canvas.width; },  
 95234: () => { return screen.width; },  
 95259: () => { return window.innerWidth; },  
 95285: () => { return window.innerHeight; },  
 95312: () => { if (document.fullscreenElement) return 1; },  
 95358: () => { return Module.canvas.width; },  
 95390: () => { return screen.width; },  
 95415: () => { document.exitFullscreen(); },  
 95442: () => { if (document.fullscreenElement) return 1; },  
 95488: () => { return Module.canvas.width; },  
 95520: () => { return parseInt(Module.canvas.style.width); },  
 95568: () => { document.exitFullscreen(); },  
 95595: ($0) => { Module.canvas.style.opacity = $0; },  
 95633: () => { return screen.width; },  
 95658: () => { return screen.height; },  
 95684: () => { return window.screenX; },  
 95711: () => { return window.screenY; },  
 95738: () => { return window.devicePixelRatio; },  
 95774: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95827: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95878: () => { Module.canvas.style.cursor = 'none'; },  
 95915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96171: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96222: () => { if (document.fullscreenElement) return 1; },  
 96268: () => { return window.innerWidth; },  
 96294: () => { return window.innerHeight; },  
 96321: () => { if (document.pointerLockElement) return 1; }
};
